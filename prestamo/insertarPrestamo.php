...
$connection = new Conexion();
    ...
    foreach($_POST['elements_nombre'] AS $idEquipo){
        $consulta = "INSERT INTO detalle_movimiento(responsable_res_id, elemento_ele_id, mov_det_cantidad, movimiento_mov_id) VALUES ('$res_id','$idEquipo','$mov_cantidad','$id');";
    ...
    if ($insert) {
        echo "<script>alert('Se ha registrado el responsable correctamente');
            window.location='listarEquipo.php';
            </script>";
    } else {
