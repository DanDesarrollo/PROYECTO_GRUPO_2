...
$observacion = mysqli_query($connection->connect(), "SELECT DISTINCT mov_observacion FROM movimiento WHERE mov_id = $id") ;

$comnsultaa = "SELECT d_m.det_mov_id, d_m.responsable_res_id, m.mov_id from detalle_movimiento d_m, movimiento m, responsable r, elemento e where d_m.movimiento_mov_id=m.mov_id and d_m.elemento_ele_id=e.ele_id and d_m.responsable_res_id=r.res_id and m.mov_id='$id' ";

$consulta_herramienta = mysqli_query($connection->connect(), "SELECT * FROM elemento WHERE tipo_elemento_tip_ele_id = 1");
    ...
    <div class="row">
        <div class="col-md-6 mt-5 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="./editarHerramienta.php" id="formulario" method="POST" enctype='multipart/form-data'>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="elemen_nombre[]" list="datalistherramientas" id="exampleDataList" placeholder="Seleccione Herramienta" value="<?php echo $dm['ele_id']?>">
                    ...
                    ?>
                    <input type="hidden" name="mov_id" value="<?php echo $id?>">
