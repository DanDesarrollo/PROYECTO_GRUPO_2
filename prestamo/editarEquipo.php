<?php
    ...
    foreach($_POST['element_nombre'] AS $idEquipo){
    ...
    foreach($_POST['element_nombre'] AS $idEquipo){
        ...
        $consultas = "INSERT INTO detalle_movimiento(responsable_res_id, elemento_ele_id, movimiento_mov_id) VALUES ('$res_id','$idEquipo','$id');";
