...
<div class="row">
    <div class="col-md-4 mt-5 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="insertEstados.php" method="POST">
                    <div class="mb-3">
                        <label class="mb-3">Descripcion estado</label>
                        <input type="text" id="nombre" class="form-control" name="descripcionestado" value="">
                    </div>
                ...
                <div class="card-row text-justify text-danger">
                        <form action="../estados/consultaEstados.php">
                            <div class="d-grid mb-3">
