...
<body>
    ...
    <div class="row">
        <div class="col-md-4 mt-5 mx-auto">
            <div class="card">
                <p class="card-header fs-3 bold fw-bold text-center">Registrar cargo</p>
                <div class="card-body">
                    <form action="insertcargo.php" method="POST">
                        <div class="mb-3">
                            <label class="mb-3">Descripcion del cargo</label>
                            <input type="text" id="nombre" class="form-control" name="descripcioncargo" value="">
                        </div>
